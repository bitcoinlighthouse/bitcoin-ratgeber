...
Ein physisches Gerät, ähnlich einem USB-Stick. Der private Schlüssel verlässt das Gerät nie. Selbst an einem fremden Computer bleibt er geschützt. Empfohlen, sobald du mehr als ein paar hundert Euro in Bitcoin hältst. Bekannte Hersteller sind **Bitbox02** (bitbox.swiss) und **Trezor** (trezor.io).
...
> Bei der Zufallsgenerierung der 24 Wörter ist es trotz deutlich höherem Aufwand empfohlen, die Wörter selbst zu generieren. Wie genau das funktioniert erfährst du hier: https://bitcoinlighthouse.de/blog/seed-selbst-wuerfeln-hardware-wallet

---

→ [Kapitel 3 – Von der Börse zur eigenen Wallet](kapitel-03-von-der-boerse-zur-eigenen-wallet.md)
