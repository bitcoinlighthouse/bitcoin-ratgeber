...
A physical device, similar to a USB stick. The private key never leaves the device. Even on an unfamiliar computer it stays protected. Recommended as soon as you hold more than a few hundred euros in Bitcoin. Well-known manufacturers are **Bitbox02** (bitbox.swiss) and **Trezor** (trezor.io).
...
> When randomly generating the 24 words, it is recommended to generate the words yourself – even though this takes considerably more effort. You can find out exactly how this works here: https://bitcoinlighthouse.de/blog/seed-selbst-wuerfeln-hardware-wallet
